<template>
  <div
    ...
    :class="{
      'h-35': this.openTab === 0,
      'h-50rem': this.openTab > 0 && !checkMobile,
      'h-55': this.openTab > 0 && checkMobile
    }"
  >
    <div
      class="row mx-0"
      ...
      <div class="col-12 center-flex">
        <div class="accordion accordion-alt" role="tablist">
          <b-card no-body class="">
            <b-card-header
              header-tag="header"
              class="p-0 first mb-1px"
              :class="{ 'border-bottom-0': this.openTab === 1 }"
              role="tab"
            >
              <b-button
                block
          ...
          <b-card no-body class="">
            <b-card-header
              header-tag="header"
              class="p-0 rounded-0 mb-1px"
              :class="{ 'border-bottom-0': this.openTab === 2 }"
              role="tab"
            >
              <b-button
                block
          ...
          <b-card no-body class="">
            <b-card-header
              header-tag="header"
              class="p-0 rounded-0 mb-1px"
              :class="{ 'border-bottom-0': this.openTab === 3 }"
              role="tab"
            >
              <b-button
                block
          ...
          <b-card no-body class="">
            <b-card-header
              header-tag="header"
              class="p-0 rounded-0 mb-1px"
              :class="{ 'border-bottom-0': this.openTab === 4 }"
              role="tab"
            >
              <b-button
                block
